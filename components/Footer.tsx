    ...
    <footer className="bg-[var(--color-forest)] text-white py-10 lg:py-24 px-6 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-12 gap-10">
          ...
          {/* LEFT: Wordmark and Contact */}
          <div className="md:col-span-4 flex flex-col justify-between">
            <div className="space-y-8">
              {/* */}
              <div className="text-[28px] font-heading tracking-tight leading-none select-none">
                R<span className="text-[var(--color-ryyva-light)]">yy</span><span className="text-[var(--color-ryyva-pale)]">va</span>
              </div>
